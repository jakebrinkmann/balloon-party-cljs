...
var digit_2649 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_2650__$1 = (vlq >>> (5));
while(true){
if((vlq_2650__$1 > (0))){
var digit_2651__$1 = (digit_2649 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode.call(null,digit_2651__$1));

var G__2652 = (vlq_2650__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__2653 = (vlq_2650__$1 >>> (5));
digit_2649 = G__2652;
vlq_2650__$1 = G__2653;
continue;
} else {
sb.append(cljs.source_map.base64.encode.call(null,digit_2649));
}
break;
}
...
var G__2654 = i__$1;
var G__2655 = result__$1;
var G__2656 = shift__$1;
i = G__2654;
result = G__2655;
shift = G__2656;
continue;
